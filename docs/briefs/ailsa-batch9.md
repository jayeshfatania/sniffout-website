...
TASK: Write walk descriptions for six Cotswolds and
Herefordshire walk pages.
...
WALKS TO WRITE FOR:
1. Chipping Campden and Dover's Hill
2. Bourton-on-the-Water and the Windrush Valley
3. Broadway Tower and Fish Hill
4. Cleeve Hill and Cleeve Common
5. Symonds Yat Rock and the Wye Valley
6. Malvern Hills Worcestershire Beacon Circuit
...
Step 2: Trigger Developer pane
tmux send-keys -t sniffout:1 "cat ~/Desktop/sniffout-website/docs/briefs/developer-batch9.md" Enter
