...
offLead: "full"
offLeadDescription: "Full off-lead throughout Canbury Gardens and the Thames Path. Two-level path: upper shared with cyclists, lower path (pedestrians only) is quieter and better for off-lead. Ham Lands (optional detour) is off-lead on rough grassland with no livestock. On-lead at Teddington Lock weir."
livestock: false
hasStiles: false
hasParking: true
parking: "Lower Ham Road car park (KT2 5AU) - right at Canbury Gardens, small, fills fast on weekends. Plan B: John Lewis Kingston (KT1 1QZ) or Bentall Centre, 10-12 minutes walk south along the river."
hazards:
...
returnOptions:
  ...
  - type: "train"
    detail: "Teddington Station to Kingston Station, South Western Railway, ~8 mins. Verify current timetable at nationalrail.co.uk before visiting."
  - type: "bus"
...
routeLegs:
  ...
  - name: "Lock to The Anglers"
    distance: "0.15 km"
    time: "~3 min"
    note: "Cross footbridges to Twickenham bank"
    dogStatus: "On-lead"
    statusClass: "onlead"
  - name: "Optional: Ham Lands detour"
    distance: "0.6 km+"
    time: "~15 min+"
    note: "South bank grassland, ground-nesting birds Mar-Jul"
    dogStatus: "Off-lead"
    statusClass: "offlead"
