...
terrain: "paved"
offLead: "partial"
offLeadDescription: "Partial. Ham Lands (south bank between Teddington and Richmond): fully off-lead year-round - walk through it on the Thames Path without crossing the river. Leads near Teddington Lock weir. Petersham Meadows: total dog ban April to October (PSPO protecting Belted Galloway cattle)."
livestock: true
hasStiles: false
hasParking: true
parking: "Cedar Road car park, Teddington (TW11 9AN) - 22 bays, chargeable, fills early on weekends. Plan B: Teddington Pool car park (TW11 8EZ), 42 bays. Richmond end: public transport preferred, resident parking zones."
walkType: "linear"
startPoint: "Teddington Lock, Cedar Road car park (TW11 9AN)"
endPoint: "Richmond Bridge, Richmond station (TW9 2NA)"
returnOptions:
  - type: "walk"
    detail: "Walk back the same route along the south bank."
  - type: "train"
    detail: "Train from Richmond to Teddington (South Western Railway). Verify timetable at nationalrail.co.uk before visiting."
waterAccess: true
waterAccessDescription: "Thames accessible above Teddington Lock (non-tidal, safe for paddling). Do not swim near the lock weir or in the tidal section below the lock."
tidal: false
hazards:
  - livestock
founderTipLabel: "Jay and Luna's tip"
founderTip: "The Petersham diversion is genuinely just as good as the main path - you get a closer river view and you are not missing anything by taking it. The climb up to Richmond Hill at the end is steep enough to feel like you have earned it, and the view from the Terrace benches at golden hour is one of the best free things in London."
routeLegs:
  - name: "Teddington Lock through Ham Lands"
    distance: "3.4 km"
    time: "~50 min"
    note: "South bank grassland, or stick to riverside path"
    dogStatus: "Off-lead (on-lead at lock)"
    statusClass: "offlead"
  - name: "Petersham Meadows PSPO diversion"
    distance: "0.54 km"
    time: "~10 min"
    note: "Signed diversion Apr-Oct, riverside path"
    dogStatus: "On-lead"
    statusClass: "onlead"
  - name: "Petersham to Richmond Hill"
    distance: "0.2 km"
    time: "~5 min"
    note: "Steep climb through Terrace Gardens"
    dogStatus: "On-lead"
    statusClass: "onlead"
  - name: "Richmond Hill to Richmond town"
    distance: "1.0 km"
    time: "~10 min"
    note: "Downhill to station, protected viewpoint at top"
    dogStatus: "On-lead"
    statusClass: "onlead"
walkWarning:
  title: "Petersham Meadows - total dog ban"
  body: "Dogs are completely banned from Petersham Meadows from **1 April to 31 October**. This is a PSPO enforced by Richmond Council to protect the Belted Galloway cattle - a criminal offence, not just an advisory. Take the signed riverside diversion at Petersham Nursery junction."
heroImage: "/img/walks/teddington-to-richmond-thames-path.jpg"
gallery:
  - src: "/img/walks/teddington-to-richmond-thames-path-2.jpg"
    caption: "The riverside path looking towards Richmond Hill"
    credit: "Photo: Sniffout"
  - src: "/img/walks/teddington-to-richmond-thames-path-3.jpg"
    caption: "Jay and Luna at the top of Richmond Hill"
    credit: "Photo: Sniffout"
  - src: "/img/walks/teddington-to-richmond-thames-path-4.jpg"
    caption: "Overlooking the riverside at sunset"
    credit: "Photo: Sniffout"
  - src: "/img/walks/teddington-to-richmond-thames-path-5.jpg"
    caption: "Walking towards Richmond with Richmond Bridge in the distance"
    credit: "Photo: Sniffout"
  - src: "/img/walks/teddington-to-richmond-thames-path-6.jpg"
    caption: "Looking back at Richmond Bridge under a full moon"
    credit: "Photo: Sniffout"
badge: "Hidden gem"
date: 2026-04-15
---
...
**Seasonal notes:** 1 April to 31 October - the Petersham Meadows PSPO is in force. Dogs are completely banned from the meadows during this period. The riverside diversion at the Petersham Nursery junction is the correct route - it is clearly signed and adds very little distance. Build this into your planning rather than discovering it at the junction. Early morning and golden hour on Richmond Hill - the climb to Richmond Hill earns its best views in early morning light or the hour before sunset. Mid-afternoon on a busy summer weekend the terrace area gets crowded. Aim for before 9am or after 6pm in summer for the best experience of the viewpoint. Summer heat - the south bank path between Teddington and Petersham is relatively open and exposed in places with less tree cover. On hot days the river access points along Ham Lands are the main cooling option before the shaded climb through Terrace Gardens. Carry water. Winter - the flat south bank path is good year-round. The Terrace Gardens climb can be slippery after rain. Take it steady on the descent into Richmond after wet weather.
...
**Dog-friendly stops:** The Roebuck (130 Richmond Hill, TW10 6RN) - sits directly opposite the famous viewpoint at the top of Richmond Hill, which makes it one of the better-positioned pubs in south-west London. Water bowls, treats, and a decent range of ales. On sunny days take drinks across to the Terrace benches for the full front-row seat over the Thames valley. Dogs are welcome, the welcome is genuine, and the location does most of the work. The Lass O'Richmond Hill (8 Queens Road, TW10 6JJ) - a classic Young's pub with a proper dog-friendly policy: water bowls and treats on arrival, pub dog Pickles usually somewhere nearby. A short steep walk up from the river but worth it for the atmosphere. One of the better pub interiors in Richmond - real ale, good food, no pretension. The Dysart Petersham (Petersham Road, TW10 7AA) - Michelin-starred and genuinely dog-friendly, with towels by the door for muddy paws. This is not a casual pint stop - the Dysart is a serious post-walk dining venue where booking ahead is expected and you will spend accordingly. Water bowls provided, the welcome is warm, and the cooking is the best within walking distance of this route. The White Hart (1 Riverside, Twickenham, TW1 3DX) - a riverside pub on the north/Twickenham bank, and only relevant to this walk if you cross the Teddington Lock footbridges or Richmond Bridge to the Middlesex side. Not on the standard south bank route. Dogs welcome, riverside terrace, multiple recent sources confirm good dog access.
