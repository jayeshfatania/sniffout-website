...
### Pages live
- Homepage
- Walks index + 48 individual walk pages (all with FAQ blocks and schema.org markup, weather preview card with lat/lng front matter)
- Guides index + guide articles (see content/guides/)
- Area index pages: 20 live (Surrey, London, New Forest, Yorkshire, Sussex, Lake District, Dartmoor, Hampshire, Hertfordshire, Edinburgh, Brecon Beacons, Snowdonia, Gower, South Wales, West Wales, Peak District, North East England, Fife, Loch Lomond, Perthshire)
- Install page (/get)
- About page
...
### SEO infrastructure
- FAQ blocks on all 48 walk pages with schema.org FAQPage markup
- 20 area index pages capturing regional dog walk searches
...
8. Batch 7: North West England walks (Formby Beach, Beacon Fell, Rivington Pike, Lyme Park) - next walk batch
9. Remaining walk batches: Midlands, Cotswolds, Shropshire, East of England, South West
